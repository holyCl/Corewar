...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/21 18:46:19 by inazarin          #+#    #+#             */
/*   Updated: 2018/11/21 18:46:35 by inazarin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			or_op_helper(const int *args_array, const unsigned int *args, t_pc *process)
{
...
void				or_op(t_vm *vm, t_pc *process)
{
	...
	if (aox_op_validation(args_array, &tmp_pos))
	{
		...
		or_op_helper(args_array, args, process);
