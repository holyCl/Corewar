...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/21 18:45:58 by inazarin          #+#    #+#             */
/*   Updated: 2018/11/21 18:46:10 by inazarin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

static int			aox_op_validation(int *args, unsigned int *tmp_pos)
{
	unsigned int	step;
	int	i;
...
static void			and_op_helper(const int *args_array, unsigned int *args, t_pc *process)
{
...
void				and_op(t_vm *vm, t_pc *process)
{
	...
	if (aox_op_validation(args_array, &tmp_pos))
	{
		...
		and_op_helper(args_array, args, process);
